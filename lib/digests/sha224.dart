...
class SHA224Digest extends MD4FamilyDigest implements Digest {
  ...
  SHA224Digest(Map<Param, dynamic> params)
      : super("SHA-224", params, Endianness.BIG_ENDIAN, 8, 64, 7);
  ...
  void processBlock() {
    ...
    for (var t = 16; t < 64; t++) {
      buffer[t] =
          clip32(_Theta1(buffer[t - 2]) + buffer[t - 7] + _Theta0(buffer[t - 15]) + buffer[t - 16]);
    }
