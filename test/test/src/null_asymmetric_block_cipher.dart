...
/**
 * An implementation of a null [AsymmetricBlockCipher], that is, a cipher that does not encrypt,
 * neither decrypt. It can be used for testing or benchmarking chaining algorithms.
 */
class NullAsymmetricBlockCipher extends BaseAsymmetricBlockCipher {
  ...
  NullAsymmetricBlockCipher(Map<Param, dynamic> params, this.inputBlockSize, this.outputBlockSize)
      : super("Null", params);
